...
const requestSubLecturer = require("../controllers/lecturer/subLecturer/requestSubLecturer");
const handleSubLecturerRequest = require("../controllers/lecturer/subLecturer/handleSubLecturerRequest");
const getPendingSubLecturers = require("../controllers/lecturer/subLecturer/getPendingSubLecturers");
const getSubLecturers = require("../controllers/lecturer/subLecturer/getSubLecturers");
const removeSubLecturer = require("../controllers/lecturer/subLecturer/removeSubLecturer");
