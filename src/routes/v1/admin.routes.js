...
const adminFindUsersHandler = require("../../controllers/v1/admin/dean/users/fetchUsers")
const adminFetchCoursesHandler = require("../../controllers/v1/admin/dean/courses/fetchCourses")
const adminFetchEnrollmentsHandler = require("../../controllers/v1/admin/dean/enrollments/fetchEnrollments")
const adminFetchQuizSubmissionsHandler = require("../../controllers/v1/admin/dean/quizzes/fetchSubmissions")
