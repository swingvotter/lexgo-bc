...
// Student controllers
const applyToCourseHandler = require("../../controllers/v1/enrollment/applyToCourse");
const getEnrolledCoursesHandler = require("../../controllers/v1/enrollment/getEnrolledCourses");

// Lecturer controllers
const getPendingRequestsHandler = require("../../controllers/v1/enrollment/getPendingRequests");
const approveOrRejectEnrollmentHandler = require("../../controllers/v1/enrollment/approveOrRejectEnrollment");
